 ...
 * exact versions (React >= 19.2, ensureCorrectIsomorphicReactVersion). That
 * skew is invisible to typecheck and every non-rendering test — it shipped to
 * production once, when the load-bearing react pin in apps/convex/package.json
 * re-keyed the react-email tree onto react@19.1.0 while react-dom (then
 * undeclared, auto-installed as a transitive peer) stayed at 19.2.4.
 *
