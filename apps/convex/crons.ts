...
// to its current billable member count: real accounts active in the past
// 6 months and not manually marked inactive ($1/month each).
// See functions/memberActivity.ts for the activity definition.
