  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={[styles.loadingText, { color: colors.textSecondary }]}>Loading integrations...</Text>
      </View>
    );
  }
      ...
      >
        ...
        {integrations && integrations.length > 0 ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>No integrations available</Text>
          </View>
        )}
      </ScrollView>
    </View>
