...
export default function AvailabilityProfileScreen() {
  const router = useRouter();
  const insets = useSafeAreaInsets();
  const { refreshUser, signIn } = useAuth();
  const { token, phone, countryCode, otp, responses, phoneVerificationToken } = useLocalSearchParams<{
    token: string;
    phone: string;
    countryCode: string;
    otp: string;
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            This helps your leader know who's available to serve
          </Text>
