...
export const queryKeys = {
  ...
  leaderTools: {
    ...
    meeting: (groupId: string | number, meetingId: string) =>
      ['meeting', groupId, meetingId] as const,
  },
  ...
  admin: {
    ...
    communityMembers: (search?: string, groupId?: string) =>
      ['admin', 'community-members', ...(search ? [search] : []), ...(groupId ? [groupId] : [])] as const,
    communityMemberDetail: (userId: number) =>
      ['admin', 'community-member-detail', userId] as const,
  },
  ...
  integrations: {
    ...
    planningCenterStatus: () => ['integrations', 'planning-center', 'status'] as const,
  },
} as const;
